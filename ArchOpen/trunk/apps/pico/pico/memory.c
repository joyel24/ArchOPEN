...
u32 UnusualRead16(u32 a, int realsize)
{
  ...
  //dprintf("ret = %02x", realsize==16 ? d : d>>8);
  return d;
}
...
#else
unsigned int  m68k_read_memory_8(unsigned int address)  { return PicoRead8(address); }
unsigned int  m68k_read_memory_16(unsigned int address) { return PicoRead16(address); }
unsigned int  m68k_read_memory_32(unsigned int address) { return PicoRead32(address); }

void m68k_write_memory_8(unsigned int address, unsigned int value)  { PicoWrite8(address, (u8)value); }
void m68k_write_memory_16(unsigned int address, unsigned int value) { PicoWrite16(address,(u16)value); }
void m68k_write_memory_32(unsigned int address, unsigned int value) { PicoWrite32(address, value); }
#endif
#endif // EMU_M68K
