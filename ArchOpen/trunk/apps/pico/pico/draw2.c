...
extern unsigned int *myBitmap; // in format (8+320)x(8+224+8) (eights for borders)
int currpri = 0;
...
unsigned int *PicoCramHigh=HighPal; //for 32bits YUV
...
static int TileXnormYnorm(unsigned int *pd,int addr,unsigned int *pal)
{
...
static int TileXflipYnorm(unsigned int *pd,int addr,unsigned int *pal)
{
	unsigned int pack=0; unsigned int t=0, blank = 1;
	int i;
...
static int TileXnormYflip(unsigned int *pd,int addr,unsigned int *pal)
{
	unsigned int pack=0; unsigned int t=0, blank = 1;
	int i;
...
static int TileXflipYflip(unsigned int *pd,int addr,unsigned int *pal)
{
	unsigned int pack=0; unsigned int t=0, blank = 1;
	int i;
...
static void DrawWindowFull(int start, int end, int prio)
{
	...
	unsigned int *scrpos = (unsigned int *) myBitmap;
...
//	unsigned char pal;
	...
	unsigned int *scrpos = (unsigned int *) myBitmap, *pd = 0;
...
{
	unsigned int back, i;
	unsigned int *p=(unsigned int *)myBitmap;
...
{
	// prepare cram?
	if(PicoPrepareCram) UpdatePalette();//*PicoPrepareCram();*/
